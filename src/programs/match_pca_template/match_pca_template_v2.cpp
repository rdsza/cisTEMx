...
// current_output.OpenFile(current_output_file.ToStdString( ), true);
             std::string input_mrc_filename  = "/home/useradmin/Match_PCA_template_repo/cisTEM/src/programs/match_pca_template/Reconstructed_15000_components_ribosome.mrc";
