class EulerSearch {
  ...
  public:
    ...
    void InitGridThetaBin(wxString wanted_symmetry_symbol, float wanted_angular_step_size,
    ...
    void CalculateNewGridSearchPositions(bool random_start_angle = true);
    void CalculateRandomSearchPositions( );
    void SetSymmetryLimits( );
    void SetSymmetryLimitsThetaBin( );
